        ...
        <div class="div_head">
            <span>
                ...
                <span style="float: right; margin-right: 8px; font-weight: bold;">
                    <a style="text-decoration: none;" href="./index.php?r=backend/goods/add">【添加商品】</a>
                </span>
            </span>
        </div>
        <div></div>
            ...
            <table class="table_a" border="1" width="100%">
                <tbody><tr style="font-weight: bold;">
                    ...
                    <tr id="product1">
                        ...
                        <td><a href="./index.php?r=backend/goods/update&id=<?php echo $_v->goods_id;?>">修改</a></td>
                        <td><a href="./index.php?r=backend/goods/del&id=<?php echo $_v->goods_id ; ?>">删除</a></td>
                    </tr>
                    <?php 
                    		$i++;
                    	}
